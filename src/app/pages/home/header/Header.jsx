            ...
            <div className="search__input">
                ...
                <div className="search__open">
                    ...
                    <div className="row mt-4 box__item__search" >
                        ...
                        <div className="col-4  ">
                            <a className=" link__search " href="#"> Voucher</a>
                        </div>
                        <div className="col-4">
                            <a className=" link__search " href="#" > Giftcard</a>
                        </div>
                        <div className="col-4">
                            <a className=" link__search " href="#"> Ve VinID</a>
                        </div>
                        <div className="col-4">
                            <a href="#" className=" link__search " > Vi Dien Tu</a>
                        </div>
                    </div>
